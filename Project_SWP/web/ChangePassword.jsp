...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .changepass-box form { margin-top: 18px; }
        .input-group {
            display: flex;
        ...
        .form-footer a:hover { color: #764ba2; }
        ...
        .password-strength { margin-top: 6px; height: 7px; background: #e9ecef; border-radius: 3px; overflow: hidden;}
        .password-strength-bar { height: 100%; width: 0%; transition: all 0.3s; border-radius: 3px;}
        .strength-weak { background: #ff6b6b; width: 25%; }
        .strength-fair { background: #ffb84d; width: 50%; }
        .strength-good { background: #66bb6a; width: 75%; }
        .strength-strong { background: #667eea; width: 100%; }
        ...
        @media (max-width: 600px) {
            ...
            .changepass-box { padding: 15px 4vw;}
        }
    </style>
</head>
<body>
