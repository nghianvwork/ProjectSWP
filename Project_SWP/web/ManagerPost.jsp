...
<html>
    ...
    int total = (request.getAttribute("totalRecords") != null) ? (Integer) request.getAttribute("totalRecords") : posts.size();
int currentPage = (request.getAttribute("currentPage") != null) ? (Integer) request.getAttribute("currentPage") : 1;

    int recordsPerPage = (request.getAttribute("recordsPerPage") != null) ? (Integer) request.getAttribute("recordsPerPage") : 5;

    int stt = total - (currentPage - 1) * recordsPerPage;
...
if (request.getParameter("type") != null && !request.getParameter("type").isEmpty()) {
    ...
    typeParam = "&type=" + request.getParameter("type");

}

if (request.getParameter("search") != null && !request.getParameter("search").isEmpty()) {

    searchParam = "&search=" + request.getParameter("search");
                    ...
                    <div style="text-align: center; margin-top: 30px;">
                        ...
                        <ul class="pagination justify-content-center">
                            ...
                            <li class="page-item">
                                ...
                                <a class="page-link" href="ViewPostManager?page=<%= currentPage - 1 %><%= typeParam %><%= searchParam %>">Previous</a>
                            ...
                            <li class="page-item">
                                ...
                                <a class="page-link" href="ViewPostManager?page=<%= currentPage + 1 %><%= typeParam %><%= searchParam %>">Next</a>
