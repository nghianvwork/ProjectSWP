...
public class UpdatePost extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Post existingPost = dao.getPostById(postId);
            if (existingPost == null || existingPost.getCreatedBy() != user.getUser_Id()) {
                response.sendError(403, "Bạn không có quyền sửa bài viết này");
                return;
            }
